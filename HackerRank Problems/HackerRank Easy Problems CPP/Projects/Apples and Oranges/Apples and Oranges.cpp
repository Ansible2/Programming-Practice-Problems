...
int getNumberOnHouse(vector<int> distances, int treeLocation, int houseStart, int houseEnd) {

    int numberOnHouse{ 0 };
    for (auto objectDist : distances) {
        int landingLocation{ objectDist + treeLocation };
...
void countApplesAndOranges(int samsHouse_startingLocation, int samsHouse_endingLocation, int appleTreeLocation, int orangeTreeLocation, vector<int> apples, vector<int> oranges) {
    
    int applesOnHouse = getNumberOnHouse(apples, appleTreeLocation, samsHouse_startingLocation, samsHouse_endingLocation);
    int orangesOnHouse = getNumberOnHouse(oranges, orangeTreeLocation, samsHouse_startingLocation, samsHouse_endingLocation);
